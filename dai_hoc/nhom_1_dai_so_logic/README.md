...
| Folder | ID | Môn | Năm | Trạng thái |
|--------|-----|-----|-----|------------|
| dai_so_dai_cuong_co_so | A1 | Đại số đại cương (cơ sở) | 1 | Đầy đủ |
| dai_so_so_cap | A2 | Đại số sơ cấp | 1 | Đầy đủ |
| dai_so_tuyen_tinh | A3 | Đại số tuyến tính (gộp TCC1 + nâng cao) | 1–2 | Đầy đủ |
| dai_so_dai_cuong_vanh_modun | A4 | Đại số đại cương (vành, môđun) | 3 | Đầy đủ |
| ly_thuyet_nhom | A5 | Lý thuyết nhóm | 4 | Đầy đủ |

---

## Quan hệ giữa các môn (không trùng lặp)

| Môn | Nội dung | Phân biệt |
|-----|----------|-----------|
