...
\begin{luuy}
  Ký hiệu $:=$ nghĩa là ``được định nghĩa bởi''. Có thể biểu diễn tập hợp qua \textbf{biểu đồ Ven} (hình tròn minh họa giao, hợp, phần bù).
\end{luuy}
...
\subsection{Phương trình bậc hai}
