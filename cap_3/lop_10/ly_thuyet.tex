...
\begin{congthuc}[title={Phương trình chính tắc}]
  \begin{itemize}
    \item \textbf{Elip:}
      ...
      Tâm sai: $e = \dfrac{c}{a}$ \;($0 < e < 1$). Đỉnh: $A_1(-a;\,0)$, $A_2(a;\,0)$, $B_1(0;\,-b)$, $B_2(0;\,b)$.
    \item \textbf{Hypebol:}
      \[
        \dfrac{x^2}{a^2} - \dfrac{y^2}{b^2} = 1
      \]
      $F_1(-c;\, 0),\; F_2(c;\, 0)$, $c = \sqrt{a^2 + b^2}$, $|MF_1 - MF_2| = 2a$.
      Tâm sai: $e = \dfrac{c}{a}$ \;($e > 1$). Đỉnh: $A_1(-a;\,0)$, $A_2(a;\,0)$. Tiệm cận: $y = \pm\dfrac{b}{a}\,x$.
    \item \textbf{Parabol:}
      \[
        y^2 = 2px
      \]
      tiêu điểm $F\!\left(\dfrac{p}{2};\, 0\right)$, đường chuẩn $d\colon x = \dfrac{-p}{2}$.
      Đỉnh: gốc tọa độ $O(0;\,0)$. Trục đối xứng: trục $Ox$.
  \end{itemize}
\end{congthuc}
...
\begin{enumerate}[label=\textbf{Dạng \arabic*:}, leftmargin=*, align=left]
  ...
  \item Xác định các yếu tố của hypebol.
  \item Viết phương trình chính tắc của hypebol.
  \item Xác định các yếu tố của parabol.
  \item Viết phương trình chính tắc của parabol.
\end{enumerate}
