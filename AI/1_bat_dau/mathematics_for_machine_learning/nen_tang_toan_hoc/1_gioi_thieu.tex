...
\begin{enumerate}
  \item \textbf{Dữ liệu (Data):} Học máy dựa trên dữ liệu. Mục tiêu là trích xuất các mẫu và cấu trúc ý nghĩa từ dữ liệu.
  ...
  \item \textbf{Học (Learning):} Quá trình sử dụng dữ liệu sẵn có để tối ưu hóa tham số của mô hình theo một hàm mục tiêu, đánh giá mức độ hiệu quả của mô hình trên dữ liệu huấn luyện.
\end{enumerate}
\end{khainiembox}
...
\begin{luuybox}
Mục tiêu không chỉ là ghi nhớ dữ liệu huấn luyện, mà là xây dựng mô hình \textbf{tổng quát hóa tốt} sang dữ liệu chưa thấy.
\end{luuybox}
