%==============================================================================
\section*{Mục tiêu và ký hiệu}
\addcontentsline{toc}{section}{Mục tiêu và ký hiệu}
%==============================================================================

\begin{phuongphap}[title={Mục tiêu học tập}]
Sau chương này, người học có thể:
\begin{enumerate}
  \item Giải thích \textbf{bản chất} của Gradient Descent: đi theo hướng \textbf{ngược gradient} để giảm hàm mục tiêu (thường là hàm mất mát).
...
\begin{itemize}
  \item $f$, $\mathcal{L}$, $J$: hàm mục tiêu / hàm mất mát.
...
\begin{dongco}[title={Bản chất Gradient Descent --- đọc trước khi vào chi tiết}]
...
\end{enumerate}
Trong Machine Learning, ta thường \textbf{không giải được} $\nabla \mathcal{L} = 0$ bằng đại số (hàm phi tuyến, số chiều lớn, dữ liệu lớn). GD thay thế bằng đi từng bước nhỏ --- giống ``lăn xuống thung lũng'' trên bề mặt lỗi (loss landscape).
\end{dongco}
