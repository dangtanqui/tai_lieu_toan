...
\end{enumerate}
Trong Machine Learning, ta thường \textbf{không giải được} $\nabla \mathcal{L} = 0$ bằng đại số (hàm phi tuyến, số chiều lớn, dữ liệu lớn). GD thay thế bằng đi từng bước nhỏ --- giống ``lăn xuống thung lũng'' trên bề mặt mất mát (loss landscape).
\end{dongco}
