#!/usr/bin/env python3
"""Translate Machine Learning (Tom Mitchell) PDF to editable Vietnamese LaTeX.
...
BOOK_BASENAME = "MachineLearningTomMitchell"
...
COPYRIGHT_RE = re.compile(r"©\s*(Springer|McGraw-Hill)", re.I)

PROTECT_TERMS: list[str] = [
  "Machine Learning", "machine learning",
  "Tom Mitchell", "Mitchell",
  "concept learning", "Concept Learning", "Concept learning",
  "version space", "Version Space", "version spaces", "Version Spaces",
  "inductive bias", "Inductive Bias", "Inductive bias",
  ...
  "analytical learning", "Analytical Learning",
  ...
  "ID3", "CART", "FOIL", "EBL", "EM", "HMM",
  "Q-learning", "Q-Learning", "temporal difference", "Temporal Difference",
  ...
  "AirTemp", "PlayTennis", "BACKPROPAGATION", "CANDIDATE-ELIMINATION",
]

HEADING_PROTECT_TERMS: list[str] = [
  "ID3", "CART", "FOIL", "EBL", "EM", "HMM", "ANN", "BFS", "BFS-ID3",
  "BACKPROPAGATION", "SKICAT", "CANDIDATE-ELIMINATION", "FIND-S",
  "McGraw-Hill", "Machine Learning", "machine learning",
  "neural network", "Neural Network", "decision tree", "Decision Tree",
  "gradient descent", "Gradient Descent", "perceptron", "Perceptron",
  "AirTemp", "PlayTennis", "Occam",
]
...
def main() -> None:
  parser = argparse.ArgumentParser(
    description="Translate Machine Learning (Tom Mitchell) PDF to Vietnamese LaTeX",
  )
