...
\begin{luuy}[title={Mục tiêu}]
Đây không phải tutorial DataFrame đầy đủ. Mục tiêu là giới thiệu \textbf{cực nhanh} các phần của pandas DataFrame cần để làm các bài tập Colab trong ML Crash Course.
\end{luuy}
