...
\begin{enumerate}
  ...
  \item Chuyển thành lớp: \texttt{Spam} / \texttt{Not Spam}.
\end{enumerate}
\end{dongco}
...
\begin{itemize}
  ...
  \item $b$: bias; $w_i$: trọng số học được; $x_i$: đặc trưng của mẫu.
...
\begin{luuy}[title={Ví dụ: Tính $z$ và $y'$}]
Cho $b=1$, $w_1=2$, $w_2=-1$, $w_3=5$; $x_1=0$, $x_2=10$, $x_3=2$.

$z = 1 + 2 \cdot 0 - 10 + 5 \cdot 2 = 1+0-10+10=1 \Rightarrow y' = \dfrac{1}{1+e^{-1}} \approx \dfrac{1}{1{,}367} \approx 0{,}731$.
\end{luuy}
...
\begin{dinhnghia}[title={Chuẩn hóa (Regularization)}]
