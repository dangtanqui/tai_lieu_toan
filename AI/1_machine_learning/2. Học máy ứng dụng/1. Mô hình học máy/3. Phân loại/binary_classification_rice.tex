...
\def\coversubtitle{Bài tập Colab --- Phân loại 2 giống gạo (dịch tiếng Việt)}
...
\begin{luuy}[title={Trích dẫn}]
Cinar, I. and Koklu, M. (2019). ``Classification of Rice Varieties Using Artificial Intelligence Methods.''
\textit{International Journal of Intelligent Systems and Applications in Engineering}, 7(3), 188--194.
DOI: \mlccurl{https://doi.org/10.18201/ijisae.2019355381}.
\end{luuy}
...
\begin{luuy}[title={Lời giải (chạy cell để ra số)}]
\end{luuy}
...
\begin{luuy}[title={Một lời giải tham khảo}]
\end{luuy}
...
\begin{luuy}[title={Lời giải tham khảo (từ notebook)}]
\end{luuy}
