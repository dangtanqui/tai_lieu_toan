...
Tài liệu biên soạn và dịch đầy đủ từ \emph{Categorical Data} (Google Machine Learning Crash Course)\footnote{\url{https://developers.google.com/machine-learning/crash-course/categorical-data}}, tương ứng năm phần trong thư mục này. target là giữ đầy đủ ý, ví dụ, bảng và bài tập, tránh tóm tắt quá mức.
\end{ynghia}
...
\begin{itemize}
  ...
  \item Tạo \textbf{feature crosses} (feature kết hợp).
\end{itemize}
\end{phuongphap}
...
%==============================================================================
\section{feature kết hợp (feature crosses)}
%==============================================================================
...
\begin{luuy}
Dữ liệu này có thể dùng để phân loại lá theo loài cây vì các feature đó ổn định trong cùng loài.
\end{luuy}
