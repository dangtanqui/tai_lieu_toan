...
\begin{dongco}
Sau khi xem dữ liệu bằng thống kê và trực quan, biến đổi sao cho mô hình huấn luyện hiệu quả hơn. Mục tiêu \href{https://developers.google.com/machine-learning/glossary\#normalization}{chuẩn hóa}: đưa các feature về \textbf{cùng quy mô} tương đối.
\end{dongco}
...
Sau khi phát hiện, thường \textbf{sửa} bằng xóa ví dụ hoặc \textbf{impute} (điền giá trị). Chi tiết: module \href{https://developers.google.com/machine-learning/crash-course/overfitting/data-characteristics}{Đặc điểm dữ liệu} trong phần overfitting.
