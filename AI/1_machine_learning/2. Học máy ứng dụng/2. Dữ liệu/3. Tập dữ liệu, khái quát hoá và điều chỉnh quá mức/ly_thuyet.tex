...
Tài liệu biên soạn và dịch đầy đủ từ \emph{Datasets, Generalization, and Overfitting} (Google Machine Learning Crash Course)\footnote{\url{https://developers.google.com/machine-learning/crash-course/overfitting}}, tương ứng \textbf{11 phần} (file \texttt{1}--\texttt{11}) trong thư mục. target là giữ nội dung cốt lõi, các câu hỏi trắc nghiệm ``check your intuition/understanding'' và các gợi ý đáp án, tránh tóm tắt quá mức.
\end{ynghia}
...
\begin{itemize}
  \item Nhận diện bốn feature của dữ liệu và dataset.
...
\begin{ynghia}
Trong module này, ta học feature của dataset ML và cách chuẩn bị dữ liệu để đạt kết quả chất lượng cao khi huấn luyện và đánh giá mô hình.
\end{ynghia}

%==============================================================================
\section{feature dữ liệu (Data characteristics)}
%==============================================================================
...
\begin{dongco}\nMô hình ML chỉ tốt bằng dữ liệu mà nó được train. Phần này xem các feature quan trọng của dữ liệu.\n\end{dongco}
...
\begin{dinhnghia}[title={Định nghĩa thực dụng về chất lượng}]\nTrong khóa này, \textbf{dataset chất lượng cao} là dataset giúp mô hình đạt target; dataset chất lượng thấp là dataset cản trở mô hình đạt target.\n\end{dinhnghia}
...
\begin{dinhnghia}[title={Tổng quát hóa}]\n\href{https://developers.google.com/machine-learning/glossary\#generalization}{Generalization} là đối lập với overfitting: mô hình dự đoán tốt trên dữ liệu mới. Đây là target.\n\end{dinhnghia}
...
\begin{dinhnghia}[title={Regularization}]\nMô hình cần đồng thời đạt hai target mâu thuẫn: (1) khớp dữ liệu tốt; (2) khớp đơn giản nhất có thể. Một cách giữ mô hình đơn giản là phạt mô hình phức tạp trong lúc train --- đó là \\textbf{regularization}.\n\end{dinhnghia}
