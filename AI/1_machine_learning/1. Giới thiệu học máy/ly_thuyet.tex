...
\def\coversubtitle{Lý thuyết --- Khái niệm nền, học có giám sát, kiểm tra hiểu biết}
...
\begin{phuongphap}[title={Bản đồ các ô trong tài liệu}]
\begin{itemize}
  \item \textsf{\color{teal!60!black}Động cơ học} --- câu hỏi thực tế trước khi định nghĩa.
  \item \textsf{\color{blue!60!black}Định nghĩa} --- khái niệm chính thống, có liên kết \href{https://developers.google.com/machine-learning/glossary}{ML Glossary}.
  \item \textsf{\color{purple!50!black}Ý nghĩa \& Trực giác} --- giải thích ``đang nói gì''.
  \item \textsf{\color{orange!50!black}Tính chất} --- quy tắc, phân loại, điểm cần nhớ.
  \item \textsf{\color{gray!50!black}Phương pháp} --- quy trình, các bước làm.
  \item \textsf{\color{cyan!50!black}Công thức} --- biểu thức / mối quan hệ toán tắt.
  \item \textsf{\color{violet!50!black}Ví dụ} --- tình huống cụ thể.
  \item \textsf{\color{red!40!black}Phản ví dụ} --- hiểu nhầm thường gặp.
  \item \textsf{\color{olive!60!black}Ứng dụng thực tế} --- sản phẩm, ngành.
  \item \textsf{\color{red!50!black}Lưu ý} --- cạm bẫy, kiểm tra hiểu biết.
  \item \textsf{\color{blue!70!black}Tổng kết chương} --- thuật ngữ và bước tiếp theo.
\end{itemize}
\end{phuongphap}

\begin{ungdung}[title={Tài liệu tham khảo mở rộng}]
\href{https://developers.google.com/machine-learning/crash-course}{Machine Learning Crash Course} \textbullet\
\href{https://developers.google.com/machine-learning/problem-framing}{Problem Framing} \textbullet\
\href{https://pair.withgoogle.com/guidebook/}{People + AI Guidebook}.
\end{ungdung}
...
\begin{dongco}[title={Động cơ học --- Tại sao cần học máy?}]
...
\begin{dinhnghia}[title={Học máy (mức cơ bản)}]
ML là quá trình
...
\begin{luuy}[title={Kiểm tra hiểu biết}]
...
\begin{dongco}[title={Động cơ học --- Cần phân loại hệ thống ML}]
...
\begin{enumerate}
  ...
  \item \textbf{Học không giám sát} --- tìm cấu trúc, cụm, mẫu; không có nhãn cho mục tiêu.
...
\href{https://developers.google.com/machine-learning/glossary\#unsupervised-machine-learning}{Học không giám sát} tìm \textbf{mẫu có ý nghĩa} trong dữ liệu \textbf{không có nhãn} cho mục tiêu. Kỹ thuật phổ biến:
...
\begin{enumerate}
  \item Đưa dữ liệu (không cần nhãn mục tiêu).
...
\begin{congthuc}[title={Mục tiêu RL (ý tưởng)}]
...
\begin{dongco}[title={Động cơ học --- Vì sao cần năm khái niệm?}]
...
\textbf{Mẫu} (\href{https://developers.google.com/machine-learning/glossary\#example}{example}): một đơn vị --- như một dòng bảng.
...
\begin{luuy}[title={Kiểm tra hiểu biết --- Tập dữ liệu lý tưởng}]
...
\begin{luuy}[title={Kiểm tra hiểu biết --- Vì sao phải huấn luyện?}]
...
\begin{dongco}[title={Động cơ học --- Luyện chọn mô hình và đặc trưng}]
...
\begin{luuy}[title={Kiểm tra hiểu biết --- Dự đoán giá xe}]
...
\begin{luuy}[title={Kiểm tra hiểu biết --- Cải thiện mô hình}]
