...
Hồi quy logistic là thuật toán phân loại học có giám sát dùng để dự đoán \textbf{xác suất} của biến target.
...
Thông thường ``hồi quy logistic'' nghĩa là hồi quy logistic \textbf{nhị phân} với biến target nhị phân; tuy nhiên biến target có thể có thêm các dạng khác.
Theo số lớp của biến target, hồi quy logistic chia thành các loại sau.
\end{ynghia}
...
\begin{itemize}
  \item Với hồi quy logistic nhị phân, biến target phải \textbf{luôn nhị phân}; kết quả mong muốn được biểu diễn bởi mức nhân tố 1.
...
Dạng đơn giản nhất là hồi quy logistic nhị phân (binomial): biến target chỉ có hai giá trị 1 hoặc 0.
Cho phép mô hình hóa quan hệ giữa nhiều biến dự báo và biến target nhị phân.
...
\]
target chính: \textbf{tối thiểu hóa} hàm loss --- điều chỉnh trọng số (tăng/giảm).
...
Dạng hữu ích khác: hồi quy logistic \textbf{đa thức} --- biến target có 3 lớp trở lên \textbf{không có thứ tự}, không có ý nghĩa định lượng.
\end{dinhnghia}
