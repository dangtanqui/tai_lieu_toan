...
Chia dữ liệu thành các tập con theo giá trị feature đầu vào; lặp đệ quy cho đến khi mỗi tập con thuộc cùng một lớp hoặc cùng giá trị biến target.
...
Gini Index là tên hàm \textbf{cost} đánh giá các tách nhị phân trong dataset, làm việc với biến target phân loại Success/Failure (hoặc hai lớp).
