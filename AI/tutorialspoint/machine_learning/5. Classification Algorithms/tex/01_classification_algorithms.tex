...
Kỹ thuật học có giám sát dự đoán biến target \textbf{phân loại} từ tập feature đầu vào.
target: học hàm ánh xạ $f$ giữa $X$ và $Y$, thường biểu diễn bằng \textbf{ranh giới quyết định} tách các lớp trong không gian feature.
\end{dinhnghia}
