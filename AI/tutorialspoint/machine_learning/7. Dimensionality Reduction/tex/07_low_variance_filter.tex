...
Kỹ thuật \textbf{lựa chọn đặc trưng} loại các feature có \textbf{phương sai (variance)} nhỏ hơn ngưỡng. Feature gần như \textbf{không đổi} giữa các mẫu thường ít khả năng phân biệt được lớp mục tiêu.
\end{dinhnghia}
