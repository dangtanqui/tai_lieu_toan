...
\begin{ynghia}[title={Mục tiêu lựa chọn đặc trưng}]
Mục tiêu là xác định các đặc trưng \textbf{quan trọng nhất} để dự đoán biến mục tiêu, đồng thời bỏ qua đặc trưng ít quan trọng --- vốn thêm \textbf{nhiễu} vào mô hình và có thể gây \textbf{overfitting}.
\end{ynghia}
...
Không luôn dẫn tới tập đặc trưng \textbf{tối ưu toàn cục}, đặc biệt khi có đặc trưng \textbf{tương quan cao} hoặc quan hệ \textbf{phi tuyến} giữa đặc trưng và biến mục tiêu.
\end{luuy}
