...
Kỹ thuật \textbf{lựa chọn đặc trưng} (filter method) dùng để phát hiện và loại các feature \textbf{tương quan mạnh} với nhau. target: giảm số biến dự báo, hạn chế \textbf{đa cộng tuyến} (multicollinearity) --- khi hai hay nhiều biến giải thích gần như cùng một thông tin.
\end{dinhnghia}
...
\begin{enumerate}
  ...
  \item Với mỗi cặp tương quan cao, \textbf{xóa một} feature (thường giữ feature có tương quan mạnh hơn với biến target, hoặc xóa theo quy tắc cố định như trong ví dụ).
