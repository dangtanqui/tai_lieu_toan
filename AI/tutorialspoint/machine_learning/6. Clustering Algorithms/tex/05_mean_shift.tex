...
\begin{ynghia}[title={Thị giác máy tính}]
Theo dõi đối tượng, phân đoạn ảnh, trích xuất đặc trưng.
\end{ynghia}

\begin{ynghia}[title={Xử lý ảnh}]
Phân đoạn ảnh theo độ tương đồng pixel.
\end{ynghia}

\begin{ynghia}[title={Phát hiện bất thường}]
Vùng mật độ thấp có thể đánh dấu anomaly.
\end{ynghia}

\begin{ynghia}[title={Phân khúc khách hàng và mạng xã hội}]
Gom nhóm hành vi hoặc sở thích người dùng tương tự.
\end{ynghia}
