...
Hai thuật toán phân cụm dựa trên centroid được dùng rộng rãi nhất là \textbf{K-means} và \textbf{K-medoids}. Chi tiết từng thuật toán ở hai chương kế tiếp; dưới đây là giới thiệu ngắn.
\end{phuongphap}

\subsection{K-means Clustering}

\begin{dinhnghia}[title={K-means}]
K-means là thuật toán học \textbf{không giám sát} phổ biến để phân cụm dữ liệu: đơn giản, hiệu quả, gom điểm vào $K$ cụm theo độ tương tự.
\end{dinhnghia}
...
\begin{luuy}[title={Đọc tiếp}]
Hai chương sau trình bày đầy đủ K-means (bước, EM, ví dụ Python) và K-medoids (thuật toán, \texttt{sklearn\_extra}, ưu/nhược điểm).
\end{luuy}
