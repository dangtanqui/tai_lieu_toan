...
\begin{ynghia}[title={target tối thiểu}]
...
\subsection{target phân tích cụm}

\begin{dongco}[title={Hai target chính}]
\begin{itemize}
...
\begin{ynghia}[title={Ứng dụng K-Means}]
  \begin{itemize}
    ...
    \item Phân khúc khách hàng: Chia khách theo hành vi mua hoặc nhân khẩu; hỗ trợ giữ chân khách, loyalty, quảng cáo nhắm target.
