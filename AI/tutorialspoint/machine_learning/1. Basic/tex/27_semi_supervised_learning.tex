...
\tsurl{https://www.tutorialspoint.com/machine_learning/machine_learning_semi_supervised_learning.htm}.
\end{ynghia}
...
\begin{vidu}[title={Tóm tắt (theo nguồn)}]
\begin{itemize}
...
\subsubsection{Low Density Separation}
