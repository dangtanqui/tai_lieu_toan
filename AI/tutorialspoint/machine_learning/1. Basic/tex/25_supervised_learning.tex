...
\tsurl{https://www.tutorialspoint.com/machine_learning/machine_learning_supervised.htm}.
\end{ynghia}
...
Mục tiêu: học quan hệ giữa đầu vào và đầu ra sau nhiều lần huấn luyện.
\end{dinhnghia}
...
\subsubsection{1. Classification (phân loại)}

\begin{ynghia}[title={Mục tiêu}]
Dự đoán nhãn phân loại (đúng/sai, nam/nữ, có/không, \ldots) --- giá trị rời rạc, không có thứ tự bắt buộc.
\end{ynghia}

Thuật toán phổ biến: decision trees, random forests, SVM, logistic regression, \ldots

\subsubsection{2. Regression (hồi quy)}

\begin{ynghia}[title={Mục tiêu}]
Dự đoán giá trị số \textbf{liên tục}; học quan hệ giữa biến độc lập và biến phụ thuộc.
\end{ynghia}

Thuật toán phổ biến: linear regression, polynomial regression, Lasso regression, \ldots

\subsection{Thuật toán Supervised Learning}

\begin{luuy}[title={Đối chiếu}]
Danh sách mô hình tổng quan: Mục~\ref{sec:mo-hinh-ml}. So sánh supervised vs unsupervised: Mục~\ref{sec:supervised-vs-unsupervised}.
\end{luuy}
...
\begin{center}\footnotesize Nguồn: Wikipedia --- K-nearest neighbors algorithm\end{center}
...
\subsubsection{3. Decision Trees}
...
\begin{center}\footnotesize Nguồn: \tsurl{https://www.tutorialspoint.com/machine_learning/images/flowchart_format.jpg}\end{center}
...
\begin{center}\footnotesize Nguồn: \tsurl{https://www.tutorialspoint.com/machine_learning/images/distribution_data_points.jpg}\end{center}
Phân bố điểm đỏ và xanh; có thể vẽ đường biên --- điểm mới thuộc phía nào của đường quyết định thuộc lớp đó.
\end{vidu}

\subsubsection{6. Support Vector Machines (SVM)}
...
\begin{center}\footnotesize Nguồn: \tsurl{http://uc-r.github.io/svm}\end{center}
Ba lớp không tách được bằng đường thẳng; biên phi tuyến --- SVM hữu ích xác định ranh giới.
\end{vidu}

\subsubsection{7. Random Forest}
...
\begin{center}\footnotesize Nguồn: \tsurl{https://www.tutorialspoint.com/machine_learning/images/random_forest_algorithm.jpg}\end{center}
\end{vidu}

\subsubsection{8. Gradient Boosting}
...
\begin{itemize}
  \item Mục tiêu rõ ràng $\Rightarrow$ cải thiện độ chính xác dự đoán.
