%==============================================================================
\section{Khái niệm nền (đọc trước)}
...
Dữ liệu \textbf{không có nhãn}. Mục tiêu thường là tìm cấu trúc/nhóm trong dữ liệu:
...
\subsection{Chu trình giải bài toán ML (nhìn từ góc ``thực hành'')}
\label{sec:chu-trinh-ml}

\begin{phuongphap}[title={Chuỗi bước điển hình}]
\begin{enumerate}
...
\InputIfFileExists{_figures/00_khai_niem_nen.tex}{}{}
