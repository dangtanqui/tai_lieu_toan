...
\tsurl{https://www.tutorialspoint.com/machine_learning/machine_learning_challenges_common_issues.htm}.
\end{ynghia}
...
Nguồn liệt kê các thách thức/vấn đề phổ biến như sau.
\end{dongco}
...
\begin{phuongphap}[title={Cách xử lý (theo nguồn)}]
\begin{itemize}
...
\begin{phuongphap}[title={Một số vấn đề chất lượng dữ liệu (theo nguồn)}]
\begin{itemize}
  \item Missing values
...
\begin{phuongphap}[title={Một số kỹ thuật hỗ trợ (theo nguồn)}]
\begin{itemize}
...
\begin{phuongphap}[title={Một số cách xử lý (theo nguồn)}]
\begin{itemize}
...
Nguồn nêu: bias, privacy và transparency.
\end{dongco}
