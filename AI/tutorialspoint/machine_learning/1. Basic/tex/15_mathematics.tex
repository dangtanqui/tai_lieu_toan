...
\begin{itemize}
  \item \textbf{Vector và ma trận}: biểu diễn dataset, feature, giá trị target, trọng số, \ldots
...
\begin{phuongphap}[title={Gradient descent (tóm tắt)}]
...
\begin{itemize}
  ...
  \item \textbf{Bias và variance}: mô tả nguồn sai số trong dự đoán; overfitting/underfitting.
