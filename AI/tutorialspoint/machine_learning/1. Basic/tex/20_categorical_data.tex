...
\tsurl{https://www.tutorialspoint.com/machine_learning/machine_learning_categorical_data.htm}.
\end{ynghia}
...
\subsection{3. Frequency Encoding}
...
\subsection{4. Target Encoding}

\begin{dinhnghia}[title={Target encoding}]
Thay mỗi category bằng giá trị tổng hợp (thường là \textbf{trung bình}) của biến mục tiêu (target) trong nhóm category đó.
...
\begin{luuy}[title={Giảng viên lưu ý --- data leakage}]
