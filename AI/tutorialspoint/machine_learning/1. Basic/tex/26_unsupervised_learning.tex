...
\tsurl{https://www.tutorialspoint.com/machine_learning/machine_learning_unsupervised.htm}.
\end{ynghia}
...
\begin{vidu}[title={Tóm tắt một câu (theo nguồn)}]
\begin{itemize}
...
\subsubsection{2. Association Rule Mining}
...
\subsubsection{3. Dimensionality Reduction}
...
\begin{phuongphap}[title={Danh sách thường dùng (theo nguồn)}]
...
\subsection{Supervised vs Unsupervised (nhắc ngắn)}

\begin{luuy}[title={Đối chiếu}]
So sánh với supervised: Mục~\ref{sec:supervised-vs-unsupervised}.
\end{luuy}
