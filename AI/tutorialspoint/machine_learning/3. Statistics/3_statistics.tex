...
\input{tex/01_statistics.tex}
\input{tex/02_mean_median_mode.tex}
\input{tex/03_standard_deviation.tex}
\input{tex/04_percentiles.tex}
\input{tex/05_data_distribution.tex}
\input{tex/06_skewness_kurtosis.tex}
\input{tex/07_bias_variance.tex}
\input{tex/08_hypothesis.tex}
