...
Thống kê là công cụ then chốt trong học máy vì giúp hiểu pattern nền trong dữ liệu.
Nó cung cấp phương pháp mô tả, tóm tắt và phân tích dữ liệu.
Phần này giới thiệu các cơ bản thống kê cho ML.
\end{dongco}
...
\begin{itemize}
  \item \textbf{Mean, Median, Mode}: đo xu hướng trung tâm.
  \item \textbf{Standard deviation, Variance}: độ phân tán quanh mean.
  \item \textbf{Percentiles}: giá trị dưới đó một tỷ lệ \% quan sát rơi vào.
  \item \textbf{Data distribution}: cách điểm dữ liệu trải trên miền giá trị.
  \item \textbf{Skewness, Kurtosis}: độ lệch và độ nhọn của phân phối.
  \item \textbf{Bias, Variance}: nguồn sai số dự đoán mô hình.
  \item \textbf{Hypothesis}: giả thuyết / lời giải đề xuất cho bài toán.
  \item \textbf{Linear / Logistic Regression, PCA}: các kỹ thuật liên quan (chi tiết ở các phần sau Tutorialspoint).
\end{itemize}
\end{phuongphap}
...
Các chương sau trình bày chi tiết từng đại lượng thống kê kèm ví dụ Python.
\end{luuy}
