...
\begin{vidu}[title={Đồ thị tradeoff}]
...
\begin{luuy}[title={Dataset}]
Nguồn Tutorialspoint dùng Boston Housing (đã deprecated). Ví dụ dưới dùng \textbf{California Housing} từ scikit-learn, cùng bài toán hồi quy giá nhà.
\end{luuy}
