...
\begin{phuongphap}[title={Mạng target}]
Để ổn định quá trình huấn luyện, DQN dùng \textbf{mạng target riêng} sinh target giá trị $Q$.
...
Mạng nơ-ron được huấn luyện bằng \textbf{gradient descent} để tối thiểu hóa loss giữa $Q$ dự đoán và $Q$ target.
Giá trị $Q$ target tính theo \textbf{phương trình Bellman}, kết hợp phần thưởng nhận được và giá trị $Q$ \textbf{lớn nhất} của trạng thái kế tiếp.
\end{phuongphap}
...
\begin{phuongphap}[title={Cách tính target}]
