...
\begin{itemize}
  ...
  \item Cân bằng giữa \textbf{cải thiện target} và \textbf{ổn định} học.
\end{itemize}
\end{tinhchat}
...
\begin{phuongphap}[title={target clipped (PPO-clip)}]
...
\begin{itemize}
  ...
  \item \textbf{Natural gradient}: điều chỉnh bước theo geometry policy; lõi của TRPO, có thể kết hợp các target khác.
\end{itemize}
\end{tinhchat}
