...
Các thuật toán Deep RL có khả năng quyết định hành động nào nên thực hiện để tối ưu mục tiêu ngay cả khi đầu vào có kích thước lớn.
\end{dinhnghia}
...
Mục tiêu là phát triển chiến lược tối ưu để xử lý gián đoạn.
\end{phuongphap}
