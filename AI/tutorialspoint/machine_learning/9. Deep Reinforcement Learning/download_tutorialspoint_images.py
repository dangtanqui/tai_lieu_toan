...
MAPPING = {
    "1. deep reinforcement learning.txt": "01_deep_reinforcement_learning",
    "2. deep reinforcement learning algorithms.txt": "02_deep_rl_algorithms",
    "3. deep q-networks (dqn).txt": "03_deep_q_networks",
    "4. deep deterministic policy gradient (ddpg).txt": "04_ddpg",
    "5. trust region methods.txt": "05_trust_region_methods",
}
