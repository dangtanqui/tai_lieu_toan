...
\begin{itemize}
  ...
  \item \textbf{Chọn đặc trưng (feature selection)}: biểu đồ quan hệ với biến mục tiêu giúp giữ biến có sức dự đoán, loại biến nhiễu.
...
Dữ liệu ML thường chia thành:
\begin{itemize}
  \item \textbf{Biểu đồ một biến (Univariate Plots)}.
  \item \textbf{Biểu đồ nhiều biến (Multivariate Plots)}.
\end{itemize}
\end{phuongphap}
...
\begin{tinhchat}[title={Đặc điểm histogram}]
\begin{itemize}
