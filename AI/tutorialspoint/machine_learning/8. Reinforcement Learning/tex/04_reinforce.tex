...
\begin{dongco}[title={Lịch sử và mục tiêu}]
Thuật toán do Ronald J. Williams giới thiệu (1992).
Mục tiêu: \textbf{tối đa hóa phần thưởng tích lũy kỳ vọng} bằng cách điều chỉnh tham số policy; agent học ra quyết định \textbf{tuần tự} trong môi trường.
\end{dongco}
