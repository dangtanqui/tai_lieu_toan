...
\begin{dongco}[title={target học tăng cường}]
Thuật toán học tăng cường huấn luyện \textbf{agent} ra quyết định tối ưu trong môi trường.
target là \textbf{tối đa hóa phần thưởng tích lũy} (cumulative reward) theo thời gian.
...
\begin{enumerate}
  ...
  \item \textbf{Q-Learning} --- thuật toán \textbf{off-policy}, model-free, học $Q^*(s,a)$: phần thưởng kỳ vọng tối đa cho cặp trạng thái--hành động; target tìm policy tối ưu qua hàm Q tối ưu.
