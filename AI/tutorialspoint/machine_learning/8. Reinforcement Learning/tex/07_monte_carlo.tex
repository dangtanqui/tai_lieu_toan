...
Episode có thể sinh bởi \textbf{chính sách hành vi} khác chính sách \textbf{target} đang tối ưu; học từ quỹ đạo do policy khác tạo. Cần \textbf{trọng số importance sampling} để chỉnh cập nhật cho đúng phân phối target.
\end{ynghia}
