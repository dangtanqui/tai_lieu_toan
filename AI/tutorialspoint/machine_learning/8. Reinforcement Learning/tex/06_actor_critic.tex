...
\begin{phuongphap}[title={Mục tiêu}]
...
SAC là off-policy, thêm \textbf{điều hòa entropy} vào mục tiêu để khuyến khích khám phá; tối ưu đồng thời return kỳ vọng và độ ``mềm'' của chính sách --- cân bằng khai thác--khám phá tốt trên hành động liên tục.
\end{ynghia}
...
\begin{enumerate}
  ...
  \item Cập nhật critic: giảm sai số TD hoặc MSE giữa $V_w$ và return mục tiêu.
