...
*   A
    ...
    The number of actual positives identified correctly
    
*   B
    
    The fraction of correctly predicted positives out of total predicted positives
    
*   C
    
    The count of predictions classified incorrectly by the model
    
*   D
    
    The percentage of all predictions classified correctly
    

When is high recall preferred over high precision?  
...
*   D
    ...
    When accuracy is the main concern
    

Which of the following is __not__ used in calculating Precision?
...
Which situation is best suited for using recall as the primary evaluation metric?
...
*   C
    ...
    When missing a positive case is costly or dangerous
    
*   D
    
    When the model makes very few predictions
